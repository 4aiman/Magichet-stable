...
function modstore.successfulldialog()
        local new_dlg = dialog_create("store_downloading",
                function(data)
                        ...
                        retval = retval .. "image_button[2.5,1.5;1,0.8;"..mm_texture.basetexturedir.."menu_button.png;btn_confirm_mod_successfull;" .. fgettext("ok") .. ";true;true;"..mm_texture.basetexturedir.."menu_button_b.png]"
                end,
                function(this,fields)
...
function modstore.getshortmodinfo(ypos,listentry,details)
        ...
        if details.basename then
                ...
                retval = retval .."image_button[9.1," .. buttony .. ";2.5,0.5;"..mm_texture.basetexturedir.."menu_button.png;btn_install_mod_" .. details.id .. ";"

                if modmgr.mod_exists(details.basename) then
                        retval = retval .. fgettext("re-Install") ..";true;true;"..mm_texture.basetexturedir.."menu_button_b.png]"
                else
                        retval = retval .. fgettext("Install") ..";true;true;"..mm_texture.basetexturedir.."menu_button_b.png]"
                end
        end
...
function modstore.getmodlist(list,yoffset)
        ...
        local close_button = "image_button[4," .. (sb_y_end + 0.3 + yoffset) ..
                        ";4,0.8;"..mm_texture.basetexturedir.."menu_button.png;btn_modstore_close;" .. fgettext("Close store") .. ";true;true;"..mm_texture.basetexturedir.."menu_button_b.png]"
        ...
        scrollbar = scrollbar .. "image_button[11.6," .. (sb_y_start)
                                .. ";0.5,0.5;"..mm_texture.basetexturedir.."menu_button.png;btn_modstore_page_up;^;true;true;"..mm_texture.basetexturedir.."menu_button_b.png]"
        scrollbar = scrollbar .. "image_button[11.6," .. (sb_y_start + sb_y_end - 0.5)
                                .. ";0.5,0.5;"..mm_texture.basetexturedir.."menu_button.png;btn_modstore_page_down;v;true;true;"..mm_texture.basetexturedir.."menu_button_b.png]"
...
function modstore.getsearchpage(tabview, name, tabdata)
        ...
        retval = retval ..
                "image_button[9.5,0.2;2.5,0.8;"..mm_texture.basetexturedir.."menu_button.png;btn_modstore_search;".. fgettext("Search") .. ";true;true;"..mm_texture.basetexturedir.."menu_button_b.png]"..
